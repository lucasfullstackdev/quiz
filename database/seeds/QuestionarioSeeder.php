    ...
    public function run()
    {
        $questionarios = [
            [
                ...
                'ds_questionario_icon' => 'storage/icons/sem-justa-causa.png'
            ],
            [
                'ds_questionario' => 'Demissão por justa causa',
                'ds_questionario_icon' => 'storage/icons/justa-causa.png'
            ],
            [
                'ds_questionario' => 'Acidente no trabalho',
                'ds_questionario_icon' => 'storage/icons/acidente-no-trabalho.png'
            ],
            [
                'ds_questionario' => 'Assédio Moral',
                'ds_questionario_icon' => 'storage/icons/assedio-moral.png'
            ]
        ];
